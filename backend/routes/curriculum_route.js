...
const { getCurricula, getCurriculumByHome, getCurriculumByType, getCurriculumBySemester, getCurriculumByKeyword, getCurriculumByUser, postCurriculum} = require('../controllers/curriculum_controller');
